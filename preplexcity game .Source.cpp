...
void frontscreen(void)
{
	...
	glColor3f(1, 1, 1);
	output(5, 160,        "SAMBHRAM INSTITUE OF ENGINEERING");
	glColor3f(1, 1, 1);
	...
	glColor3f(1, 0, 1);
	output(40, 100, "By :ANSHU BANU A");
	glBegin(GL_LINES);
	glVertex2f(40, 98);
	glVertex2f(50, 98);
	glEnd();
	glColor3f(1, 0, 0);
	output(40, 90, "TEAM MEMBERS: ANSHU and BHOOMIKA and AKSHAYA ");

	output(40, 80, "");
	glColor3f(1, 0, 1);
	output(40, 60, "Under the Guidence of : Prof.ANITHA K");
	glBegin(GL_LINES);
	glVertex2f(40, 58);
	glVertex2f(98, 58);
	glEnd();
	...
	glColor3f(1, 0, 0);
	output(70, 40, "Lecturer:Saranya B,Dept. of CSE");
	glColor3f(1, 0, 0);
	output(40, 30, "");
	glColor3f(1, 0, 0);
	drawstring(72, 30, "(B.E.)", GLUT_BITMAP_HELVETICA_12);
    output(70, 20, "Lecture:ANITHA K,Dept. of CSE");
	glFlush();
...
void winscreen()
{
	...
	output(35, 60, "* PRESS ESC TO GO TO MAIN MENU OR PAUSE THE GAME");
...
void instructions()
{
	...
	output(-20, 60, "* IF YOU ARE LOST,PRESS 1 TO START FROM THE BEGINNING");
	output(-20, 40, "* YOU HAVE 90 SECONDS TO FINISH THE GAME");
